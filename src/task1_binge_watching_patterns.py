...
def main():
    ...
    input_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-vamsikopparthi24/input/movie_ratings_data.csv"
    output_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-vamsikopparthi24/outputs/binge_watching_patterns.csv"
